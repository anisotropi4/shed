...
The base geography and population data is based on:

* The base map of mainland Britain is derived from the [WorldPop](https://hub.worldpop.org) base maps under [CC 4.0 by deed](https://creativecommons.org/licenses/by/4.0/) retrieved 2023-09-07.
* OpenStreetMap data is then used to validate and also to identify 10 stations locations which is licensed under [CC-BY-SA 2.0](https://openstreetmap.org/copyright ) through the [OverPassAPI Turbo](https://overpass-turbo.eu/) service.
...
| Product                                                                                                                                             | Note  | Owner   | Licence     |
|:----------------------------------------------------------------------------------------------------------------------------------------------------|:--------|:-------|:------------|
| [NaPTAN & NPTG](https://beta-naptan.dft.gov) | This CSV and XML API contains information for all passenger transport nodes including rail, bus-stops, ferry terminals and airports. [PDF user guide](http://www.naptan.org.uk/schema/2.4/doc/NaPTANSchemaGuide-2.4-v0.57.pdf) | [Department for Transport (DfT)](https://findtransportdata.dft.gov.uk/) | Open (OGL3) |
| [Station attributes for all mainline stations in GB](https://dataportal.orr.gov.uk/statistics/infrastructure-and-environment/rail-infrastructure-and-assets/table-6329-station-attributes-for-all-mainline-stations/) | Table 6329: Station attributes for all mainline stations, Great Britain as ODS file. | [Office of Road and Rail (ORR)](https://dataportal.orr.gov.uk/) | Open (OGL3) |
...
| Product                                                                                                                                             | Note    | Owner  | Licence     |
|:----------------------------------------------------------------------------------------------------------------------------------------------------|:--------|:-------|:------------|
| [Origin Destination Matrix 2018-19](https://raildata.org.uk/dashboard/dataProduct/P-c1b1cbbc-9fc5-425e-a0c9-9aa6cb5c619f/overview)        | Origin and destination matrix (ODM) financial year 2018-19 | [Office of Road and Rail (ORR)](https://dataportal.orr.gov.uk/) | Open (OGL3) |
| [Origin Destination Matrix 2019-20](https://raildata.org.uk/dashboard/dataProduct/P-ea6deaac-fae4-4708-8307-36ad13732a7b/overview)        | Origin and destination matrix (ODM) financial year 2019-20 | [Office of Road and Rail (ORR)](https://dataportal.orr.gov.uk/) | Open (OGL3) |
| [Origin Destination Matrix 2020-21](https://raildata.org.uk/dashboard/dataProduct/P-ba359b71-58c9-4f42-8c9d-e02e8e3a4330/overview)        | Origin and destination matrix (ODM) financial year 2020-21 | [Office of Road and Rail (ORR)](https://dataportal.orr.gov.uk/) | Open (OGL3) |
| [Origin Destination Matrix 2021-22](https://raildata.org.uk/dashboard/dataProduct/P-a9faf6fd-b31f-491c-935a-f4ab3ffa5890/overview)        | Origin and destination matrix (ODM) financial year 2021-22 | [Office of Road and Rail (ORR)](https://dataportal.orr.gov.uk/) | Open (OGL3) |
| [Origin Destination Matrix 2022-23](https://raildata.org.uk/dashboard/dataProduct/P-a839de9f-eafa-495e-92e3-ff23a33ad876/overview)        | Origin and destination matrix (ODM) financial year 2022-23 | [Office of Road and Rail (ORR)](https://dataportal.orr.gov.uk/) | Open (OGL3) |
| [Origin Destination Matrix 2023-24](https://raildata.org.uk/dashboard/dataProduct/P-420268d5-b082-469e-98e4-47d92f714bc6/overview)        | Origin and destination matrix (ODM) financial year 2023-24 | [Office of Road and Rail (ORR)](https://dataportal.orr.gov.uk/) | Open (OGL3) |


## Additional Network Rail Data
| Product                                                                                                                                         | Note   | Owner    | Licence     |
|:------------------------------------------------------------------------------------------------------------------------------------------------|:-------|:---------|:------------|
| [Daily Footfall](https://raildata.org.uk/dashboard/dataProduct/P-ba403ccb-1d64-40a7-8a53-23e8d05e6026/overview)                                 | Count in and out of the concourse area of Network Rail managed rail stations as CSV. | [Network Rail](https://www.networkrail.co.uk/) | Open (OGL3) |
...
| [Track Gradient](https://raildata.org.uk/dashboard/dataProduct/P-9931256f-ae3f-4475-abc5-e92842e1103b/overview)                                 | R&D Track Gradient uses LiDAR to automatically generate track-level gradient data. | [Network Rail](https://www.networkrail.co.uk) | Open (OGL3) |
| [Workforce Headcount](https://raildata.org.uk/dashboard/dataProduct/P-597c224e-df7a-4511-a4a7-0dcb4e6cd94b/overview)                            | Network Rail headcount by functions for each period of the financial year. | [Network Rail](https://www.networkrail.co.uk) | Open (OGL3) |

# Reference
Resources and other reference material used for talks and visualisations

::: {}
(@) [International Klein Blue (#002FA7)](https://en.wikipedia.org/wiki/International_Klein_Blue)
(@) [Rail Alphabet](https://www.strathpefferjunction.com/british-railway-typefaces-fonts/), description and download
(@) SPSmiler, [“London Underground Tube”](https://commons.wikimedia.org/wiki/File:Why_London_Underground_is_nicknamed_The_Tube.jpg)
...
(@) Rail Development Group [“Concept of Operations – Stock and Crew System"](https://www.raildeliverygroup.com/media-centre-docman/acop/284-rdgconceptofoperations-stockandcrewv1-0-reformat/file.html),  (RDG-CONOPS/NTI/002), Issue 1.1, January 2021
...
(@) [Global Human Settlement layer](https://human-settlement.emergency.copernicus.eu/), data licensed under [creative commons 4.0](https://creativecommons.org/licenses/by/4.0/)
(@) [OpenStreetMap](https://openstreetmap.org), data licensed under [Open Database License (ODbL) v1.0](https://opendatacommons.org/licenses/odbl/1-0/)
(@) [python](https://Python.org) language,    licensed under [PSF for python 3](https://docs.python.org/3/license.html)
(@) [Pandas](https://pandas.pydata.org/), licensed under BSD 3-clause license
(@) [GeoPandas](https://geopandas.org/), licensed under BSD 3-clause license
...
(@) [Shapely](https://shapely.readthedocs.io/en/stable/) python package for the manipulation and analysis of planar geometric objects, licensed under BSD 3-clause license
...
(@) Python [Tobler](https://pysal.org/tobler) interpolation and mapping package, under BSD license
(@) [QGIS](https://qgis.org), a Geographic Information System (GIS), licensed under the Attribution-ShareAlike 3.0 license
...
(@) [Uber H3](https://github.com/uber/h3-py) Uber python hexagon library, licensed under the Apache license 2.0
