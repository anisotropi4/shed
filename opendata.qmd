---
title: "Open Data for public-transport and other visualisation"
toc: true
execute:
  cache: true
  message: false
...
2. EU [Global Human Settlement layer](https://human-settlement.emergency.copernicus.eu/ghs_stat_ucdb2015mt_r2019a.php) data licensed under [creative commons 4.0](https://creativecommons.org/licenses/by/4.0/).
...
5. European and Global WorldPop 1km² data [Population Counts](https://hub.worldpop.org/project/categories?id=3) under [CC 4.0 by deed](https://creativecommons.org/licenses/by/4.0/).
6. Base global [WorldPop country boundary](https://hub.worldpop.org/geodata/listing?id=62) data under [CC 4.0 by deed](https://creativecommons.org/licenses/by/4.0/) retrieved 2025-11-01.
7. Tom Forth's [population around a point](https://www.tomforth.co.uk/circlepopulations/) tool that shows the population within a circle of a given radius under [CC 4.0 by deed](https://creativecommons.org/licenses/by/4.0/).

## Archive and Alternative Base Geography and Population Data
1. EU [Global Human Settlement layer](https://human-settlement.emergency.copernicus.eu/), data licensed under [creative commons 4.0](https://creativecommons.org/licenses/by/4.0/)
2. Alternative EU [Global Human Settlement layer](https://human-settlement.emergency.copernicus.eu/ghs_pop2022.php) data licensed under [creative commons 4.0](https://creativecommons.org/licenses/by/4.0/).
...
(@) Tom Forth's [population around a point](https://www.tomforth.co.uk/circlepopulations/) tool that shows the population within a circle of a given radius under [CC 4.0 by deed](https://creativecommons.org/licenses/by/4.0/).
(@) Ordnance Survey [Open River](https://www.ordnancesurvey.co.uk/products/os-open-rivers) data under [OpenGovernment (OGL) 3](http://os.uk/opendata/licence).
(@) [NationalGrid](https://connecteddata.nationalgrid.co.uk/) spatial [transmission grid](https://connecteddata.nationalgrid.co.uk/dataset/?groups=system-and-network&res_format=gpkg) data under the [National Grid open data](https://commercial.nationalgrid.co.uk/open-data-licence) license.
(@) [UK National Atmospheric Emissions Inventory (NAEI)](https://naei.energysecurity.gov.uk/) data on air pollutant and CO₂ emission data under [OpenGovernment (OGL) 2](https://www.nationalarchives.gov.uk/doc/open-government-licence/version/2/).
:::